        ...
        PairHeap
        PairHeap_initialize( void )
        {
            return NULL;
        }

        PairHeap
        PairHeap_makeEmpty( PairHeap H )
        {
            if( H != NULL )
            {
                PairHeap_makeEmpty( H->LeftChild );
                PairHeap_makeEmpty( H->NextSibling );
                free( H );
            }
            return NULL;
        }
...
/* START: fig12_54.txt */
        ...
        PairHeap
        PairHeap_decreaseKey( Position P, ElementType Delta, PairHeap H )
        {
            if( Delta < 0 )
...
/* START: fig12_55.txt */
        PairHeap
        PairHeap_deleteMin( ElementType *MinItem, PairHeap H )
        {
            Position NewRoot = NULL;

            if( PairHeap_isEmpty( H ) )
...
/* END */
        ...
        int
        PairHeap_isEmpty( PairHeap H )
        {
            return H == NULL;
        }

        int
        PairHeap_isFull( PairHeap H )
        {
            return 0;   /* Never full */
        }

        void
        PairHeap_destroy( PairHeap H )
        {
            PairHeap_makeEmpty( H );
        }
