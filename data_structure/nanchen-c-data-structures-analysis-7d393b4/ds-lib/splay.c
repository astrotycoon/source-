        ...
        SplayTree
        SplayTree_makeEmpty( SplayTree T )
        {
            if( T != NullNode )
            {
                SplayTree_makeEmpty( T->Left );
                SplayTree_makeEmpty( T->Right );
                free( T );
            }
            return NullNode;
        }
        ...
        SplayTree
        SplayTree_find( ElementType X, SplayTree T )
        {
            return Splay( X, T );
        }

        SplayTree
        SplayTree_findMin( SplayTree T )
        {
            return Splay( NegInfinity, T );
        }

        SplayTree
        SplayTree_findMax( SplayTree T )
        {
...
/* START: fig12_7.txt */
        SplayTree
        SplayTree_insert( ElementType Item, SplayTree T )
        {
...
/* START: fig12_8.txt */
        SplayTree
        SplayTree_remove( ElementType Item, SplayTree T )
        {
            Position NewTree;
...
/* END */
        ...
        ElementType
        SplayTree_retrieve( SplayTree T )
        {
            return T->Element;
        }
