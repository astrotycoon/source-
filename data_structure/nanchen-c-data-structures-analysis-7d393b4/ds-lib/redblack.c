...
/* END */
        ...
        void
        RedBlack_output( ElementType Element )
        {
            printf( "%d\n", Element );
        }
...
/* START: fig12_13.txt */
        ...
        DoPrint( RedBlackTree T )
        {
            ...
            {
                DoPrint( T->Left );
                RedBlack_output( T->Element );
                DoPrint( T->Right );
            }
        }

        void
        RedBlackTree_printTree( RedBlackTree T )
        {
            DoPrint( T->Right );
        }
/* END */
        ...
        RedBlackTree
        RedBlackTree_makeEmpty( RedBlackTree T )
        {
        ...
        Position
        RedBlackTree_find( ElementType X, RedBlackTree T )
        {
            if( T == NullNode )
                return NullNode;
            if( X < T->Element )
                return RedBlackTree_find( X, T->Left );
            else
            if( X > T->Element )
                return RedBlackTree_find( X, T->Right );
            else
                return T;
        }

        Position
        RedBlackTree_findMin( RedBlackTree T )
        {
            T = T->Right;
        ...
        Position
        RedBlackTree_findMax( RedBlackTree T )
        {
...
/* START: fig12_16.txt */
        ...
        RedBlackTree
        RedBlackTree_insert( ElementType Item, RedBlackTree T )
        {
            X = P = GP = T;
...
/* END */
        ...
        RedBlackTree
        RedBlackTree_remove( ElementType Item, RedBlackTree T )
        {
        ...
        ElementType
        RedBlackTree_retrieve( Position P )
        {
            return P->Element;
        }
